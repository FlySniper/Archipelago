...
ITEM_DATA: list[GenericItemData] = [
    ...
    _char(66, "Jango Fett", 59, abilities=BOUNTY_HUNTER | BLASTER),
    ...
    _char(88, "Jawa", 22, abilities=SHORTIE),
    ...
    _char(109, "Boba Fett", 7, abilities=BOUNTY_HUNTER | BLASTER),
    ...
    _char(119, "R2-Q5", 314, abilities=ASTROMECH),
